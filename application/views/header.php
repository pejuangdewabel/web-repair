...
<body>
	<noscript>
		<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Error!</strong> Your browser does not support JavaScript! Please enable Javascript to use this software. Thank you.</div>
	</noscript>
	<script>
		var kodebrowse = 116;
		var kodecari = 115;
