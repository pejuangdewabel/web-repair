<div class="container">
	...
	<form class="form-horizontal">
		<fieldset>
				...
				<div class="control-group span12" style="height:15px">
					...
					<div class="controls">
						<div class="input-append">
							<input type="text" name="sales_code" id="sales_code" oldvalue="" browseobj="cari_kode_sales" style="width:50px" />
							<a class="add-on browse" id="cari_kode_sales" href="cari?ref=sales_code&tipe=sal" title="Klik untuk mencari Kode sales">
			...
			<div class="row">
				<div class="pecontrol-group span12" style="height:15px">
			...
			<div class="row">
				<div class="span12 tab-pane active ju" style="height:200px" id="ju">
					...
					<table class="table">
						<thead>
							<tr>
								<th>Begin Periode<span style="color:red">*</span>
								</th>
								<th>End Periode<span style="color:red">*</span>
								</th>
								<th>Net Profit From<span style="color:red">*</span>
								</th>
								<th>Net Profit Until<span style="color:red">*</span></th>
								<th>Percentage Commision<span style="color:red">*</span></th>
							</tr>
						</thead>
						<tbody id="transaksix">
						</tbody>
...
<script>
	...
	function add_row_sales_comision(i, action) {
		let tabel = '<tr class="sales-comision-row" id="sales-comision-' + i + '">';
				...
				$.post('db_read', {
					...
					if (result === '') {
						...
						for (; data['jadwal'][i]; i++) {
							...
							$('#sales-comision-' + i + '-target_min').val(parseFloat(data['jadwal'][i]['target_min'])).formatCurrency({
								colorize: true,
								negativeFormat: '-%s%n',
								roundToDecimalPlace: 2
							});
							$('#sales-comision-' + i + '-target_max').val(parseFloat(data['jadwal'][i]['target_max'])).formatCurrency({
								colorize: true,
								negativeFormat: '-%s%n',
								roundToDecimalPlace: 2
							});
